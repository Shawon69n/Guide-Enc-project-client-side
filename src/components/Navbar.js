    ...
    <div class="navbar bg-blend-darken">
      ...
      <div class="navbar-center hidden lg:flex">
        <ul class="menu menu-horizontal p-0">
          ...
          <li className='font-thin text-xl'><Link to='/services'>Services</Link></li>
          <li className='font-thin text-xl'><Link to='/contact'>Contact</Link></li>
        </ul>
      </div>
      <div class="navbar-end mr-5">
        <Link to='/login' className='border-green-400 text-xl font-bold rounded-xl p-2 border-b-2'>Login</Link>
      </div>
    </div>
  );
};
